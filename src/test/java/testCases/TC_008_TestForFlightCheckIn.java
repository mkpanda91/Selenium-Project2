...
public class TC_008_TestForFlightCheckIn extends BaseDriverClass {
	...
	@Feature("Additional Features - CheckIn")
	@Description("This test attempts to check the message displayed, when incorrect PNR is provided during CheckIn")
	public void testFlightCheckIn(String pnrNumber, String email) {
		try {
